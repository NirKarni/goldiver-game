...
$(document).ready(function () {
    ...
    //document.getElementById("savetextanswer").disabled = true;
    //document.getElementById("savetextanswer").classList.add("disabledbtn");
    //console.log("ready!");
...
function disableBTN() {
    var letterCount = document.getElementById("mytextAnswerTB").value;
    var radio = document.getElementsByTagName("RadioButtonList3");

    if (letterCount.length < 1) { // && (document.getElementById("RadioButtonList3").SelectedValue == "true" || document.getElementById("RadioButtonList3").SelectedValue == "false")
        document.getElementById("savetextanswer").disabled = true;
        document.getElementById("savetextanswer").classList.remove("SaveBTN");
        document.getElementById("savetextanswer").classList.add("disabledbtn");
    } else {
        document.getElementById("savetextanswer").disabled = false;
        document.getElementById("savetextanswer").classList.remove("disabledbtn");
        document.getElementById("savetextanswer").classList.add("SaveBTN");
    }
}
